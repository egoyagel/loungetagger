...
api_id = int(os.environ.get("29579781"))
api_hash = os.environ.get("a20cf6445561d9faca307fe3d33147c7")
bot_token = os.environ.get("2092736130:AAH581F5Bu9Rvgh4LG1bkQ4t2ovB3k3C8e0")
...
async def start(event):
  await event.reply("**Ego Tagger **, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/egotagger_robot?startgroup=a'),
                      ]
                    ),
                    link_preview=False
                   )
